...
const string AssetsPath = @"C:\Users\firat\source\repos\MLDersleri\Ranking\Assets";
...
(IDataView, IDataView) BuildTrainEvaluateAndSaveModel(MLContext mlContext)
{
...
void TestSinglePrediction(MLContext mlContext, IDataView predictions, IDataView testDataView)
{
...
void GetData(string inputPath, string outputPath, string trainDatasetPath, string trainDatasetUrl, string testDatasetUrl, string testDatasetPath, string validationDatasetUrl, string validationDatasetPath)
{
...
void PrintTopModels(ExperimentResult<RankingMetrics> experimentResult, uint optimizationMetricTruncationLevel)
{
