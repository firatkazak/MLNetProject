...
string assetsRelativePath = @"C:\Users\firat\source\repos\MLDersleri\DeepLearningImageClassification.Predict\assets";
string assetsPath = GetAbsolutePath(assetsRelativePath);
string imagesFolderPathForPredictions = Path.Combine(assetsPath, "inputs", "images-for-predictions");
string imageClassifierModelZipFilePath = Path.Combine(assetsPath, "inputs", "MLNETModel", "imageClassifier.zip");
