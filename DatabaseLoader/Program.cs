using DatabaseLoader.DataModels;
...
Microsoft.ML.Data.DatabaseLoader loader = mlContext.Data.CreateDatabaseLoader<UrlClick>();
...
EstimatorChain<OneHotEncodingTransformer> CatogoriesTranformer = mlContext.Transforms.Conversion
    .ConvertType(nameof(UrlClick.Label), outputKind: DataKind.Boolean)
...
EstimatorChain<ITransformer> featuresTransformer = CatogoriesTranformer
    .Append(mlContext.Transforms.Text.FeaturizeText(outputColumnName: "Feat01Featurized", inputColumnName: nameof(UrlClick.Feat01)))
...
EstimatorChain<ColumnConcatenatingTransformer> finalTransformerPipeLine = featuresTransformer.Append(mlContext.Transforms.Concatenate
    (
    "Features", "Feat01Featurized", "Feat02Featurized", "Feat03Featurized", "Feat04Featurized", "Feat05Featurized", "Feat06Featurized", "Feat07Featurized", "Feat08Featurized",
    "Feat09Featurized", "Feat10Featurized", "Feat11Featurized", "Feat12Featurized", "Feat12Featurized", "Cat14Encoded", "Cat15Encoded", "Cat16Encoded", "Cat17Encoded",
    "Cat18Encoded", "Cat19Encoded", "Cat20Encoded", "Cat21Encoded", "Cat22Encoded", "Cat23Encoded", "Cat24Encoded", "Cat25Encoded", "Cat26Encoded", "Cat27Encoded",
    "Cat28Encoded", "Cat29Encoded", "Cat30Encoded", "Cat31Encoded", "Cat32Encoded", "Cat33Encoded", "Cat34Encoded", "Cat35Encoded", "Cat36Encoded", "Cat37Encoded",
    "Cat38Encoded", "Cat39Encoded"
    ));

EstimatorChain<FieldAwareFactorizationMachinePredictionTransformer> trainingPipeLine =
    finalTransformerPipeLine.Append(mlContext.BinaryClassification.Trainers.FieldAwareFactorizationMachine(labelColumnName: "Label", featureColumnName: "Features"));
...
TransformerChain<FieldAwareFactorizationMachinePredictionTransformer> model = trainingPipeLine.Fit(trainTestData.TrainSet);
...
PredictionEngine<UrlClick, ClickPrediction> predictionEngine = mlContext.Model.CreatePredictionEngine<UrlClick, ClickPrediction>(model);
...
ClickPrediction clickPrediction = predictionEngine.Predict(sampleData);

Console.WriteLine($"Predicted Label: {clickPrediction.PredictedLabel} - Score:{Sigmoid(clickPrediction.Score)}", System.Drawing.Color.YellowGreen);
...
void DetachDatabase(string userConnectionString)
{
