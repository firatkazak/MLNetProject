...
//Bu class, örnek MNIST (el yazısı rakamları) verilerini saklar. Her bir veri, InputData tipinde ve 64 adet piksel değeri içeren bir dizi ile temsil edilir. Her bir dizi, 8x8 boyutunda bir el yazısı rakamının piksellerini temsil eder.
//MNIST1, MNIST2, ve MNIST3 adında üç adet InputData nesnesi içerir.
//Her bir InputData nesnesi, 64 adet piksel değeri içeren bir dizi(PixelValues) içerir.
