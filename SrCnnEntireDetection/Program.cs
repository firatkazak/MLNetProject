...
string BaseDatasetsRelativePath = @"C:\Users\firat\source\repos\MLDersleri\SrCnnEntireDetection\Data";
string DatasetRelativePath = $"{BaseDatasetsRelativePath}/phone-calls.csv";
...
void DetectAnomaly(IDataView dataView)
{
